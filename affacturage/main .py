...
CHANGE_TEMPLATE = (
    "Bonjour,<br>"
    "Vous trouverez en piece jointe le rapport listant les partenaires dont l'affacturage est mal renseigne.<br>"
    "Bonne journee."
)

NO_CHANGE_TEMPLATE = (
    "Bonjour,<br>"
    "Toutes les donnees d'affacturage sont conformes.<br>"
    "Bonne journee."
)
