...
CHANGE_TEMPLATE = (
    "Bonjour,<br>"
    "Vous trouverez en piece jointe le rapport listant les partenaires avec une Family Producer mal renseignee.<br>"
    "Bonne journee."
)

NO_CHANGE_TEMPLATE = (
    "Bonjour,<br>"
    "Toutes les donnees Family Producer sont conformes.<br>"
    "Bonne journee."
)
ERROR_TEMPLATE = (
    "<p>"
    "Une erreur est survenue lors du controle Family Producer. Voici le message d'erreur :<br><br>"
    "{error_message}<br><br>"
    "Bonne journee."
    "</p>"
)
...
def _get_subject(has_attachment: bool) -> str:
    status = "" if has_attachment else " (Aucun changement)"
    return f"MDM Quality Check Report - [ {SUBJECT} ]{status}"
